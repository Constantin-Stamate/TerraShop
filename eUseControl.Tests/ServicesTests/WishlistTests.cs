...
namespace eUseControl.Tests.ServicesTests
{
    ...
    public class WishlistTests
    {
        ...
        public void AddNullProduct()
        {
            ...
            var result = _wishlist.AddProductToWishlist(userId, productId);
        ...
        [TestMethod]
        public void GetProductsInvalidUser()
        {
            int userId = -1;

            var result = _wishlist.GetAllWishlistProducts(userId);
        ...
        [TestMethod]
        public void GetProductsNoWishlist()
        {
            int userId = 4;
        ...
        public void RemoveInvalidInput()
        {
            ...
            var result = _wishlist.RemoveProductFromWishlist(productId, userId);
        ...
        [TestMethod]
        public void GetProductIdsInvalidUser()
        {
            int userId = -1;

            var result = _wishlist.GetWishlistProductIds(userId);
        ...
        [TestMethod]
        public void GetProductIdsSuccess()
        {
            int userId = 2;
